...
const HeroSection: FC<IHeroSectionProps> = ({ lang }) => {
  return (
    <SectionWrapper>
      <Heading gradient="secondary" className="text-center w-10/12" size="h2">
        {langSwitcher(
          lang,
      ...
      <Heading className="text-center mt-10 w-8/12" size="h5">
        {langSwitcher(
          lang,
      ...
      <Button className="mt-20 mb-[150px]" variant="warning" shape="pill">
        {langSwitcher(lang, "Get Started Today", "শুরু করার ঠিক সময় এখনই")}
